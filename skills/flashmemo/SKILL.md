...
| 分类 | 判断标准 | 关键词示例 | 示例 |
|------|---------|-----------|------|
| **memo (备忘/待办)** | **还没发生的事**、待办、提醒、计划、未来事件 | 记得、别忘了、待办、提醒、要、准备、打算、计划 | "教晨晨拆婴儿车"、"整理代表处信息"、"记得明天交报告" |
...
**⚠️ 核心原则（必须遵守！）**：
1. **待办/提醒/计划 → memo（ImportantMemo.md）**：所有还没发生的事都是 memo！
2. **已发生的事 → work/life/account**：已经做完的事才分到这三个目录
3. **账目优先**：只要涉及金额数字 + 货币单位，必须分类为 account
